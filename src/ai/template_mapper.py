...
STANDARD_CATALOG = {
    ...
    "quote_date":      "견적일자 (누름틀)",
    "sup_name":        "공급자 상호 (설정 공급자정보 → 셀필드)",
    "sup_reg_no":      "공급자 등록번호 (설정 공급자정보 → 셀필드)",
    "sup_ceo":         "공급자 대표자명+'   (인)' (설정 공급자정보 → 셀필드)",
    "sup_address":     "공급자 주소 (설정 공급자정보 → 셀필드)",
    "sup_biz_type":    "공급자 업태 (설정 공급자정보 → 셀필드)",
    "sup_biz_item":    "공급자 종목 (설정 공급자정보 → 셀필드)",
    "sup_manager":     "공급자 담당자 (설정 공급자정보 → 셀필드)",
    "sup_tel":         "공급자 전화번호 (설정 공급자정보 → 셀필드)",
    "sup_email":       "공급자 이메일 (설정 공급자정보 → 셀필드)",
    "sup_fax":         "공급자 팩스번호 (설정 공급자정보 → 셀필드)",
    "svc_name":        "용역명 (셀필드)",
    "svc_period":      "용역기간 (셀필드)",
